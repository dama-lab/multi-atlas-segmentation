...
**[Important] Please make sure the orientation information in the header of your test image is correct before process**. It is a bit tricky to get the correct orientation for nifty images. Please see the detailed information in the answer of the first question in the Q/A session.
